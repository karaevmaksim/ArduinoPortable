...
user in an INI file next to ArduinoPortable.exe called ArduinoPortable.ini.
...
copy AppNamePortable.ini from this directory to ArduinoPortable.ini next to
ArduinoPortable.exe. The options in the INI file are as follows:
